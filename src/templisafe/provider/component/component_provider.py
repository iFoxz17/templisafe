...
class ComponentProvider:
    ...
    def provide_template_engine(
        self, template_engine: TemplateEngine | TemplateEngineSettings | None = None
    ) -> TemplateEngine:
    ...
    def provide_template_parser(self, template_parser: TemplateParserSettings | None = None) -> TemplateParser:
    ...
    def provide_variant_parser(
        self, variant_parser: VariantParser | VariantParserSettings | None = None
    ) -> VariantParser:
    ...
    def provide_compiler(self, compiler: Compiler | CompilerSettings | None = None) -> Compiler:
        """Delegates to the designated provider to return a `Compiler` instance."""
        return self._compiler_provider.provide(compiler)

    def provide_renderer(self, renderer: Renderer | RendererSettings | None = None) -> Renderer:
