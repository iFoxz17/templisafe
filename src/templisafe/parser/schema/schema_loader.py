...
class SchemaLoader:
    ...
    def __init__(self, default_settings: SchemaParserSettings | None = None) -> None:
        self._default_settings: SchemaParserSettings = default_settings or SchemaParserSettings.from_yaml(
            SCHEMA_PARSER_SETTINGS_YAML
        )
        self._manager: SchemaParserManager = SchemaParserManager(settings=DEFAULT_MANAGER_SETTINGS)
