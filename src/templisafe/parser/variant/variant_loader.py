...
class VariantLoader:
    ...
    def __init__(self, default_settings: VariantParserSettings | None = None) -> None:
        self._default_settings: VariantParserSettings = default_settings or VariantParserSettings.from_yaml(
            VARIANT_PARSER_SETTINGS_YAML
        )
        self._manager: VariantParserManager = VariantParserManager(settings=DEFAULT_MANAGER_SETTINGS)
