...
class TemplateLoader:
    ...
    def __init__(self, default_settings: TemplateParserSettings | None = None) -> None:
        self._default_settings: TemplateParserSettings = default_settings or TemplateParserSettings.from_yaml(
            TEMPLATE_PARSER_SETTINGS_YAML
        )
