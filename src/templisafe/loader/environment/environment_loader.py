...
from templisafe.loader.environment.environment_manager import EnvironmentManager
...
from templisafe.exceptions.environment_error import IllegalEnvironmentDefinitionError
