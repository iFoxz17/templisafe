...
def test_factory_creates_sequential_executor(factory: SourceExecutorFactory, executor_settings_sequential: SourceExecutorSettings):
...
def test_factory_creates_thread_pool_executor(factory: SourceExecutorFactory, executor_settings_thread_pool: SourceExecutorSettings):
...
def test_manager_get_or_create_thread_pool(manager: SourceExecutorManager, executor_settings_thread_pool: SourceExecutorSettings):
...
def test_manager_contains_only_cached_executors(manager: SourceExecutorManager, executor_settings_sequential: SourceExecutorSettings):
