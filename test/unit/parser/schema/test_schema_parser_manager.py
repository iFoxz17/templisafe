...
from templisafe.parser.schema.schema_parser_manager import SchemaParserFactory, SchemaParserManager
...
@pytest.fixture
def custom_schema_settings(default_schema_settings: SchemaParserSettings) -> SchemaParserSettings:
...
@pytest.mark.parametrize(
    "settings_fixture",
    ["default_schema_settings", "custom_schema_settings"]
)
...
# -----------------------------
def test_manager_caching_behavior(default_schema_settings, custom_schema_settings, schema_parser_manager: SchemaParserManager):
