...
from templisafe import Build, SourceSettings, Templater, TemplaterFactory
...
def test_full_build_with_inline_sources():
    ...
    # ------------------------------------------------------------------
    template_source = SourceSettings.create(kind="inline", content_type="text", content=TEMPLATE_YAML_STR)

    schema_source = SourceSettings.create(kind="inline", content_type="yaml", content=SCHEMA_YAML_STR)

    variants_1_source = SourceSettings.create(kind="inline", content_type="yaml", content=VARIANTS_1_YAML_STR)

    variants_2_source = SourceSettings.create(kind="inline", content_type="yaml", content=VARIANTS_2_YAML_STR)
