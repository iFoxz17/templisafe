...
def schema_parser_manager() -> SchemaParserManager:
    ...
    return SchemaParserManager(settings=DEFAULT_MANAGER_SETTINGS)


@pytest.fixture
def resolver(
    default_settings: SchemaParserSettings, schema_parser_manager: SchemaParserManager
...
def test_resolver_resolve_with_settings(resolver: SchemaParserResolver, custom_settings: SchemaParserSettings):
...
def test_resolver_resolve_with_none(resolver: SchemaParserResolver, default_settings: SchemaParserSettings):
...
def test_resolver_respects_manager_caching(resolver: SchemaParserResolver, custom_settings: SchemaParserSettings):
