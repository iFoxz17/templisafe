...
def test_assemble_with_custom_template_engine_settings():
    assembler = TemplateEngineAssembler()
    custom_settings = TemplateEngineSettings.from_yaml(CUSTOM_TEMPLATE_ENGINE_SETTINGS_YAML)
    resolver = assembler.assemble(default_template_engine_settings=custom_settings)
...
def test_assemble_with_all_custom_settings():
    ...
    custom_template_engine_settings = TemplateEngineSettings.from_yaml(CUSTOM_TEMPLATE_ENGINE_SETTINGS_YAML)
