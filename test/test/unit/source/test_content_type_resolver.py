...
def s3_settings() -> AwsS3BucketSourceSettings:
    return AwsS3BucketSourceSettings(content_type=None, bucket="my-bucket", key="my-key.yaml", **AWS_COMMON_KWARGS)
...
def custom_source_settings() -> CustomSourceSettings:
    return CustomSourceSettings(content_type=None, context=None)
