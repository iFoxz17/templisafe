...
from templisafe.source.http.sync.http_sync_session_manager import (
    HttpSyncSessionFactory,
...
def settings() -> HttpSyncSessionSettings:
    return HttpSyncSessionSettings(pool_connections=5, pool_maxsize=10)
